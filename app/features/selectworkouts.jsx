  ...
  const loadWorkouts = async () => {
    try {
      ...
      const workoutsWithImages = workoutsData.map((workout) => {
        const categoryIndex = categoriesWithImages.findIndex(c => c.id === workout.category_id);
        return {
          ...workout,
                    ...
                    >
                      ...
                      <View style={styles.categoryContent}>
                        <View style={styles.workoutHeader}>
                          <Text style={styles.categoryEmoji}>{workout.category?.emoji || '💪'}</Text>
                          <View style={[styles.difficultyBadge, { backgroundColor: workout.category?.color || '#4A9EFF' }]}>
                        ...
                        <View style={styles.workoutMeta}>
                          ...
                          {workout.estimated_calories && (
                            <View style={styles.metaItem}>
                              <Ionicons name="flame-outline" size={14} color="rgba(255,255,255,0.9)" />
                              <Text style={styles.metaText}>{workout.estimated_calories} cal</Text>
                            </View>
                          )}
                        </View>
                      </View>
